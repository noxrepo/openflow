...
The \verb|OFPTC_TABLE_MISS_CONTINUE| flag directs unmatched packets to the next table in the pipeline, expect for the last table of the pipeline where unmatched packets are sent to the controller ; this is similar to how multiple tables behaved in the OpenFlow 1.0 specification. The \verb|OFPTC_TABLE_MISS_DROP| flag drops unmatched packets.
