...
Port are where packet are received by the OpenFlow pipeline and eventually forwarded. The switch may define both physical ports and logical ports, and the OpenFlow specification defines some virtual ports.
\\\\
