...
\\\\
The \verb|OFPC_INVALID_TTL_TO_CONTROLLER| flag indicates whether packet with invalid IP TTL or MPLS TTL should be dropped (default) or sent to the controller.
\\\\
