...
\item \textbf{do-output}: if the set does not contain a group action, and if packet output port is set, forward the packet on the port specified (physical or virtual port)
