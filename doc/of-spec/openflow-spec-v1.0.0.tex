...
OpenFlow-only switches do not support output actions to the \textbf{NORMAL} port, while Hybrid OpenFlow/non-OpenFlow switches may support output actions to the \textbf{NORMAL} port.  Either type of switch can also support output actions to the \textbf{FLOOD} port.
\\\\
