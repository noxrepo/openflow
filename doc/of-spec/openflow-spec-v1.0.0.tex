...
\\\\
Note: IP fragments should be reassembled before forwarding the packet to the first table if the switch configuration contains the \verb|OFPC_FRAG_REASM| flag (see~\ref{sec:switch_config}).
