...
The instruction of the set may not be duplicated and are executed in the order specified by this list, in practice the only constraint is that the Clear-Actions instruction is executed before the Write-Actions instruction.
\\\\
