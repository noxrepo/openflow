...
\hline VLAN id & 12 & All packets of Ethernet type 0x8100, 0x88a8, 0x9100, 0x9200, and 0x9300. & VLAN identifier of \emph{outermost} VLAN tag. \\
\hline VLAN priority & 3 & All packets of Ethernet type 0x8100, 0x88a8, 0x9100, 0x9200, and 0x9300. & VLAN PCP field of \emph{outermost} VLAN tag. \\
...
Push MPLS header &
- &
Push a new MPLS header onto the packet.
...
Pop MPLS header &
- &
Pop the outer-most MPLS header from the packet. \\
\hline
\end{tabularx}
...
Only applies to packets with an MPLS tag. \\
\hline
Modify MPLS traffic class &
...
\item If the packet is VLAN tagged (Ethernet type 0x8100, 0x88a8, 0x9100, 0x9200, or 0x9300), the \emph{outermost} VLAN ID and PCP fields are used in the lookup. The encapsulated Ethernet type is used in subsequent rules.
\item (Optional) For MPLS packets (Ethernet type equal to 0x8847 or 0x8848), the \emph{outermost} MPLS label and traffic class are used. Headers \emph{after} the MPLS tag are not considered as part of the match.
