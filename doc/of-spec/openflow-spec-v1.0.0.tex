...
\item \textbf{Instruction}: an operation executed when a packet matches a flow entry. An instruction either contains a set of actions to add to the action set or modifies pipeline processing.
