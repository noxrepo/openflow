...
\\\\
After the execution of the action list in a \textit{Apply-Actions} instruction, pipeline execution continues, the packet may be matched by subsequent tables as needed and the packet action set is executed as needed (see \ref{ft:actionset}). The action set of the packet is unchanged by the execution of the action list.
